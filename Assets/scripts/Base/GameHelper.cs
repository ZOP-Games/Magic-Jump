...
namespace GameExtensions
{
    ...
    public static class GameHelper
    {
        ...
        public static bool CompareWithValue(this Vector3 vector, float value,
            VectorCompareOperation vectorCompareOperation)
        {
            return vectorCompareOperation switch
            {
                VectorCompareOperation.Equal => Mathf.Approximately(vector.x, value) ||
                                                Mathf.Approximately(vector.y, value) ||
        ...
        public static bool CompareWithValue(this Vector2 vector, float value,
            VectorCompareOperation vectorCompareOperation)
        {
            return vectorCompareOperation switch
            {
